                    ...
                    <TableRow key={item.id}>
                      <TableCell>
                        <Select
                          ...
                          onValueChange={(value) => updateOrderItem(item.id, "productId", Number(value))}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <TableCell>
                        <Input
                          ...
                          min="1"
                          value={item.quantity}
                          onChange={(e) => updateOrderItem(item.id, "quantity", Number(e.target.value) || 0)}
                        />
                      </TableCell>
                      <TableCell>{product?.unit}</TableCell>
                      <TableCell>
                        <Input placeholder="備考" value={item.notes} onChange={(e) => updateOrderItem(item.id, "notes", e.target.value)} />
                      </TableCell>
                      <TableCell>
